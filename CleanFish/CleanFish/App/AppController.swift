...
class AppController: ObservableObject {                // 초기값은 fishView가 true 인 상태
    @Published var showView: ShowView = ( true, false) //showView의 인자값이 fishView, recipeView -> ShowView = (fishView: Bool, recipeView: Bool)
